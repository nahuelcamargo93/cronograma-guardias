...
- [ ] **Tarea 2.1: Creación de la Estructura de Directorios**
...
- [ ] **Tarea 2.2: Implementación de la Lógica de Doble Restricción para Debugger**
...
- [ ] **Tarea 2.3: Migración Gradual de Reglas Duras a Archivos Únicos**
...
- [ ] **Tarea 2.4: Migración Gradual de Reglas Blandas y Dobles**
...
- [ ] **Tarea 3.1: Depuración de Dependencias Globales y CLI**
...
- [ ] **Tarea 3.2: Implementación del Postprocesador**
...
- [ ] **Tarea 4.1: Estructura de Carpetas de Reportes**
