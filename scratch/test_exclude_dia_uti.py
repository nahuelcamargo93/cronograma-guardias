...
try:
    ...
    # Only exclude weekday Dia_UTI for Leandro Franco and Fernando Moyano
    target_names = ("Franco, Leandro", "Moyano, Fernando")
    for emp in empleados:
        if emp.nombre in target_names:
            ...
            print(f"Excluyendo Dia_UTI en días de semana para: {emp.nombre}")
    ...
    if status in (cp_model.OPTIMAL, cp_model.FEASIBLE):
        print("\n=== ¡VIABLE! RESULTADOS SIMULADOS (FINES DE SEMANA) ===")
        resultados = []
        ...
        for emp in empleados:
            if emp.nombre in target_names or emp.rol in ('Jefe', 'Coordinador'):
        ...
        print("¡El modelo resultó INVIABLE al excluir Dia_UTI en la semana para Leandro y Fernando!")
