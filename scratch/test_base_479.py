...
def test_base_479():
    ...
    crono_base_id = 479 # El ID anterior
    ...
    print("\n--- CASO A (Base 479) con nuevas reglas ---")
    ...
    print(f"Resultado Caso A (Base 479): {solver_a.StatusName(status_a)}")

    # Caso B: Sin las nuevas reglas
    print("\n--- CASO B (Base 479) sin nuevas reglas ---")
    ...
    print(f"Resultado Caso B (Base 479): {solver_b.StatusName(status_b)}")
