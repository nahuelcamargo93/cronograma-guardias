...
# Build model with ALL rules enabled
...
print("Resolviendo con todas las reglas activas y timeout de 30 segundos...")
solver = cp_model.CpSolver()
solver.parameters.max_time_in_seconds = 30
status = solver.Solve(modelo)
print(f"Resultado final: {status_names.get(status)}")
