...
# 1. EXCLUDE ALL 9 CLASHING EMPLOYEES FROM DISTANCIA_MINIMA_TIPO_SEMANA
ctx.exclusiones = {
...
print("Resolviendo con las exclusiones de los 9 enfermeros conflictivos...")
solver = cp_model.CpSolver()
solver.parameters.max_time_in_seconds = 30
status = solver.Solve(modelo)
print(f"Resultado de la validación: {status_names.get(status)}")
if status == cp_model.OPTIMAL or status == cp_model.FEASIBLE:
    print("[SUCCESS] ¡El modelo es viable!")
