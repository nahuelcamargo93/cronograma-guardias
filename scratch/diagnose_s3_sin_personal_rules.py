...
def test_sin_personal_rules():
    ...
    # Cargar ajustes de servicio
    ajustes_reglas = {'__servicio__': []}
    
    # Obtener empleados y LIMPIAR sus reglas individuales
    empleados = obtener_empleados(servicio_id, fecha_inicio, total_dias)
    for emp in empleados:
        emp.reglas = {} # Limpiamos todas las reglas individuales
    ...
    print(f"Estado del Solver sin reglas individuales: {solver.StatusName(status)}")
    ...
    if status == cp_model.INFEASIBLE:
        ...
        print("El modelo es viable sin reglas individuales!")

if __name__ == "__main__":
    test_sin_personal_rules()
