...
# Modify the global rule MAX_HORAS_MES_CALENDARIO in reglas_servicio_db
reglas_servicio_db['MAX_HORAS_MES_CALENDARIO'] = {'max_horas': 216}
...
print("Building model with global MAX_HORAS_MES_CALENDARIO = 216...")
