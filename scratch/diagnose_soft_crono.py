...
try:
    ...
    # 2. Correr main.py con --debug-soft y --timeout 15
    print("Ejecutando main.py con --debug-soft --timeout 15...")
    cmd = ["python", "main.py", "--servicio", "3", "--inicio", "2026-07-01", "--fin", "2026-07-31", "--debug-soft", "--timeout", "15"]
