...
def construir_modelo_test(empleados, demanda_turnos, turnos_dict, demanda_req, ajustes_demanda, dias_del_bloque, feriados, offset_dia, num_semanas, reglas_servicio, ajustes_reglas_personal, historial_semana_previa, servicio_id, reglas_a_ignorar=None, reglas_a_ignorar_por_persona=None):
    ...
    # Aplicamos suspensiones por persona
    ...
    for emp in empleados:
        ...
        for dia in range(dias_del_bloque):
            ...
            if 'ASIGNACION_FIJA' not in reglas_a_ignorar:
