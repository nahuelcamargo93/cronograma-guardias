...
cur = conn.cursor()
cur.execute("SELECT nombre, servicio_id FROM personal WHERE nombre = 'Mora, Sergio Enrique'")
row = cur.fetchone()
...
emp_mora = next(e for e in empleados if "Mora, Sergio Enrique" in e.nombre)
