...
def test_cases():
    ...
    # Caso A: Con las nuevas reglas (tal como está en la DB actual)
    print("\n--- CASO A: CON REGLAS DE CUMPLEAÑOS Y DÍA DEL PADRE/MADRE ---")
    ...
    print(f"Resultado Caso A: {solver_a.StatusName(status_a)}")

    # Caso B: Sin las nuevas reglas
    print("\n--- CASO B: SIN REGLAS DE CUMPLEAÑOS NI DÍA DEL PADRE/MADRE ---")
    ...
    print(f"Resultado Caso B: {solver_b.StatusName(status_b)}")
