...
def diagnose():
    ...
    # Apply the user's desired rules
    ...
    print("\n--- Running diagnosis with 192h and Exceptions ---")
    ...
    for regla in lista_reglas:
        ...
        if intentar_resolver(modelo_test):
            print(f"  [WARN] Disabling '{regla}' makes the model FEASIBLE!")
        else:
            print(f"  - Disabling '{regla}' does not solve it.")
